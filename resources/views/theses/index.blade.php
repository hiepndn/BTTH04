		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="{{ route ('theses.create') }}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Add New</span></a>
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						<td> {{$these -> id}} </td>
                        <td> {{$these -> title}} </td>
                        <td> {{$these -> student -> first_name}} {{$these -> student -> last_name}}</td>
                        <td> {{$these -> program}} </td>
                        <td> {{$these -> supervisor}} </td>
                        <td> {{$these -> submission_date}} </td>
                        <td> {{$these -> defense_date}} </td>
						<td>
							<a href=" {{route('theses.edit', $these -> id)}} " class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
